...
//// nfsvoltools.VolTools methods
//func (d *NfsDriver) OpenPerms(env voldriver.Env, request nfsvoltools.OpenPermsRequest) nfsvoltools.ErrorResponse {
...
//
//	if request.Name == "" {
//		return nfsvoltools.ErrorResponse{Err: "Missing mandatory 'volume_name'"}
//	}
//
//	var ip string
//	var ok bool
...
//		return nfsvoltools.ErrorResponse{Err: `Missing mandatory 'ip' field in 'Opts'`}
//	}
//
...
//	if err != nil {
//		logger.Error("mount-volume-failed", err)
//		return nfsvoltools.ErrorResponse{Err: fmt.Sprintf("Error mounting volume: %s", err.Error())}
//	}
//
//	err = d.os.Chmod(mountPath, os.ModePerm)
//	if err != nil {
//		logger.Error("volume-chmod-failed", err)
//		return nfsvoltools.ErrorResponse{Err: fmt.Sprintf("Error chmoding volume: %s", err.Error())}
//	}
//
...
func (d *NfsDriver) persistState(env voldriver.Env) error {
	...
	stateFile := filepath.Join(d.mountPathRoot, "nfs-broker-state.json")
